          ...
          {experience.map((exp, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Content column — clickable entry. Kept intentionally
                    card-less so the rail + dots remain the visual feature;
                    Projects / Blogs use card chrome, this section earns its
                    own treatment as the page's timeline anchor. */}
