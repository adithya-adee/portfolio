...
export default function StructuredData() {
  ...
  const personSchema = {
    ...
    "description": "3rd-year Computer Science student at NITK Surathkal and Backend Developer with professional experience building scalable backend systems, Web3 integrations on Solana, and zero-knowledge proof workflows.",
    ...
    "award": [
      "Top 10% contributor — IEEE Summer of Code (May–June 2025)"
    ],
    ...
    "hasOccupation": [
      {
        ...
        "description": "Engineered 50+ REST APIs, improved latency with Redis and aggregation pipelines, implemented CI/CD, testing, and observability for a campus automation and payments platform.",
        "estimatedSalary": {
  ...
  const websiteSchema = {
    ...
    "description": "Professional portfolio showcasing backend development projects, Web3 applications, and full-stack engineering work",
    "publisher": {
      "@id": `${baseUrl}/#person`
    },
    "inLanguage": "en-US",
    ...
    "itemListElement": [
      {
        ...
        "description": "Privacy-preserving on-chain KYC verification system using Solana blockchain and Zero-Knowledge Proofs (Circom/snarkjs)",
      ...
      },
      {
        ...
        "description": "From-scratch implementation of Uniswap V2-style Automated Market Maker with constant-product formula, liquidity pools, and LP token mechanics",
        "author": { "@id": `${baseUrl}/#person` },
      ...
      },
      {
        ...
        "description": "Real-time collaborative coding environment with integrated whiteboard, AI chat powered by Gemini API, and optimized sync using Liveblocks",
        "author": { "@id": `${baseUrl}/#person` },
      ...
      },
      {
        ...
        "description": "Scalable hackathon management platform with role-based access control, normalized PostgreSQL schema, and NestJS backend architecture", 
        "author": { "@id": `${baseUrl}/#person` },
