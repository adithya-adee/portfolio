        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <div className="flex justify-center mb-8">
            <TabsList className="bg-white/5 border border-white/10 p-1 h-auto overflow-x-auto">
              <TabsTrigger
                value="all"
                className="data-[state=active]:bg-gray-400 data-[state=active]:text-white data-[state=loading]:bg-gray-600 text-gray-300 py-4 px-6 text-base font-medium  border-0 rounded-full border-white/10 whitespace-nowrap"
              >
              ...
              {projectsByCategory.map((category, index) => (
                <TabsTrigger
                  ...
                  className="data-[state=active]:bg-purple-600 data-[state=active]:text-white text-gray-300 py-4 px-6 text-base font-medium border-0 border-white/10 rounded-full whitespace-nowrap mx-1"
                >
